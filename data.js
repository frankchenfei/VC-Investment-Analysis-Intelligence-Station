(function () {
  ...
  const dealRows = [
    ...
    [943, 'co-minimax', '2026-08-19', 'C轮', 28, '阿里巴巴战投', ['高瓴创投'], '多模态模型出海，AI陪伴产品订阅增长', { cross: true }],
    [944, 'co-galaxy', '2026-08-19', 'B+轮', 22, '深创投', ['源码资本'], '仓储物流场景规模化落地', { cross: false }],
    [945, 'co-moore', '2026-08-19', 'D轮', 32, '深创投', ['联想创投'], '新一代GPU流片与生态适配提速', { cross: false }],
    [946, 'co-svolt', '2026-08-19', 'Pre-IPO', 38, '中金资本', ['国投创合'], '动力电池出海订单增长', { cross: true }],
    [947, 'co-xinnuo', '2026-08-19', 'C轮', 10, '高瓴创投', ['启明创投'], 'ADC新药临床III期推进', { cross: false }],
    [948, 'co-sensors', '2026-08-19', 'D+轮', 7, '高成资本', ['红杉中国'], 'AI数据底座进入头部企业采购', { cross: false }],
    [949, 'co-heytea', '2026-08-19', '战略轮', 28, '高瓴创投', ['老虎环球'], '海外门店扩张，供应链升级', { cross: true }],
    [950, 'co-bst', '2026-08-19', 'C轮', 20, '君联资本', ['中金资本'], '自动驾驶芯片新平台定点量产', { cross: false }],
    [951, 'co-fourier', '2026-08-19', 'D轮', 14, '高瓴创投', ['中金资本'], '人形机器人医疗康复场景放量', { cross: false }],
    [952, 'co-ronghe', '2026-08-18', 'B轮', 9, '红杉中国', ['源码资本'], '工商业储能订单与海外市场扩张', { cross: true }],
    [953, 'co-zhipu', '2026-08-20', 'B+轮', 32, '中金资本', ['红杉中国', '高瓴创投'], '大模型政企订单持续增长，推理成本进一步优化', { cross: false }],
    [954, 'co-moonshot', '2026-08-20', 'B轮', 22, '腾讯投资', ['高瓴创投'], 'Kimi月活与订阅持续增长，多模态能力升级', { cross: false }],
    [955, 'co-unitree', '2026-08-20', 'C轮', 32, '源码资本', ['红杉中国'], '新一代人形机器人量产，海外渠道扩张', { cross: true }],
    [956, 'co-biren', '2026-08-20', 'D轮', 48, '上海科创基金', ['国投创合'], '新一代国产GPU流片成功，算力中心部署提速', { cross: false }],
    [957, 'co-tailan', '2026-08-20', 'C轮', 30, '中金资本', ['淡马锡'], '全固态电池装车验证推进，产能规划落地', { cross: true }],
    [958, 'co-bawang', '2026-08-20', 'Pre-IPO', 60, '中金资本', ['高瓴创投', '老虎环球'], '港股上市进程推进，海外门店与供应链持续扩张', { cross: false }],
    [959, 'co-sensors', '2026-08-20', 'D+轮', 8, '高成资本', ['红杉中国'], 'AI分析产品进入头部企业采购，续约率提升', { cross: false }],
    [960, 'co-heytea', '2026-08-20', '战略轮', 30, '高瓴创投', ['老虎环球'], '全球门店扩张，供应链数字化升级', { cross: true }],
    [961, 'co-svolt', '2026-08-20', 'Pre-IPO', 40, '中金资本', ['国投创合'], '动力电池海外订单增长，产能扩建提速', { cross: true }],
    [962, 'co-galaxy', '2026-08-20', 'B+轮', 24, '深创投', ['源码资本'], '具身智能机器人进入仓储与制造场景', { cross: false }]
  ];
  ...
  const flows = {
    monthly: [
      ...
      ['2026-05', 820], ['2026-06', 760], ['2026-07', 690], ['2026-08', 1120]
    ],
    quarterly: {
      labels: ['2025Q3', '2025Q4', '2026Q1', '2026Q2', '2026Q3*'],
      inbound: [480, 560, 720, 650, 580],
      outbound: [310, 380, 460, 520, 390]
    },
    outboundRegions: [
  ...
  const signals = [
    ...
    { id: 'sig-19', level: 'high', cat: '赛道动量', title: 'AI多模态与应用层融资热度延续，头部项目近30天吸金超220亿元', evidence: 'MiniMax、智谱AI、澜码科技等先后交割，单笔最高35亿元', refs: ['MiniMax', '智谱AI'], ts: '2026-08-19 09:20' },
    { id: 'sig-20', level: 'high', cat: '机构动态', title: '高瓴创投近72小时连投AI、机器人与消费', evidence: '智谱AI、MiniMax、喜茶等交易完成', refs: ['高瓴创投', 'MiniMax', '喜茶'], ts: '2026-08-19 09:05' },
    { id: 'sig-21', level: 'medium', cat: '赛道动量', title: '动力电池与储能出海加速', evidence: '蜂巢能源、融和元储完成新一轮，海外订单增长', refs: ['蜂巢能源', '融和元储'], ts: '2026-08-19 08:50' },
    { id: 'sig-22', level: 'medium', cat: '资金流向', title: '外资持续参与AI与新能源大额交易', evidence: '老虎环球、淡马锡参与喜茶与固态电池项目', refs: ['老虎环球', '淡马锡'], ts: '2026-08-19 08:30' },
    { id: 'sig-23', level: 'high', cat: '赛道动量', title: 'AI大模型融资热度延续，头部项目近30天吸金超240亿元', evidence: '智谱AI、月之暗面、MiniMax等先后交割，单笔最高35亿元', refs: ['智谱AI', '月之暗面'], ts: '2026-08-20 09:20' },
    { id: 'sig-24', level: 'high', cat: '机构动态', title: '高瓴创投近一周连投AI、机器人、消费与新能源', evidence: '智谱AI、喜茶、太蓝新能源等交易完成', refs: ['高瓴创投', '智谱AI', '喜茶'], ts: '2026-08-20 09:05' },
    { id: 'sig-25', level: 'medium', cat: '赛道动量', title: '固态电池与动力电池融资持续升温', evidence: '太蓝新能源、蜂巢能源完成新一轮，装车验证推进', refs: ['太蓝新能源', '蜂巢能源'], ts: '2026-08-20 08:50' },
    { id: 'sig-26', level: 'medium', cat: '资金流向', title: '外资持续参与硬科技与消费大额交易', evidence: '老虎环球、淡马锡参与喜茶与固态电池项目', refs: ['老虎环球', '淡马锡'], ts: '2026-08-20 08:30' }
  ];
