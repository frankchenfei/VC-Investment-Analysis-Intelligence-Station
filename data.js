(function () {
  ...
  const companies = [
    ...
    ['co-lanma', '澜码科技', 'saas', '上海', 2022, 'A轮', 25, 150, ['Agent', 'RPA'], '大模型驱动的流程自动化公司'],
  ...
  const flows = {
    monthly: [
      ...
      ['2026-05', 820], ['2026-06', 760], ['2026-07', 690], ['2026-08', 830]
    ],
    quarterly: {
      labels: ['2025Q3', '2025Q4', '2026Q1', '2026Q2', '2026Q3*'],
      inbound: [480, 560, 720, 650, 390],
      outbound: [310, 380, 460, 520, 260]
    },
    outboundRegions: [
  ...
  const meta = {
    name: '资本流径',
    asOf: '2026-08-15 08:40',
    disclaimer: '演示数据 · 非实时行情',
    rangeOptions: [
